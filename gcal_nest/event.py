...
class Event(object):
    ...
    def __init__(self, db_dict=None, event=None, timezone=None):
        self.name = None
        self.event_id = None
        ...
        elif (event and timezone):
            self.from_dict(event, timezone)
    ...
    def from_db(self, db_dict):
        ...
        self.scheduled_date = arrow.get(db_dict['scheduled_date'])
        self.actioned_date = arrow.get(db_dict['actioned_date'])

    def from_dict(self, event, timezone):
